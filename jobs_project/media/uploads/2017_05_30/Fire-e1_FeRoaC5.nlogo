...
to setup
  clear-all
  resize-world (world_size_X * -1) world_size_X (world_size_Y * -1) world_size_Y
  set-patch-size size_of_patch
...
<experiment name="e1" repetitions="3" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="size_of_patch">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="world_size_X">
      <value value="200"/>
    </enumeratedValueSet>
    <steppedValueSet variable="density" first="30" step="1" last="32"/>
    <enumeratedValueSet variable="world_size_Y">
      <value value="200"/>
    </enumeratedValueSet>
  </experiment>  
</experiments>
